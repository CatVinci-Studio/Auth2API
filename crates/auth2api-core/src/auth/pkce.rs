...
mod tests {
    ...
    /// itself - getting this wrong only surfaces as an opaque token-exchange
    /// rejection at the very end of the browser flow.
    #[test]
    ...
    #[test]
    fn each_login_gets_a_fresh_verifier_and_state() {
